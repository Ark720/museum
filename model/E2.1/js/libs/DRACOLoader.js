...
THREE.DRACOLoader.prototype = {
    ...
    load: function(url, onLoad, onProgress, onError) {
        ...
        loader.load(url, function(blob,url) {
            scope.decodeDracoFile(blob,url, onLoad);
        }, onProgress, onError);
    },
     ...
     */
    decodeDracoFile: function(rawBuffer,url, callback, attributeUniqueIdMap) {
      var scope = this;
      this.attributeUniqueIdMap = (attributeUniqueIdMap !== undefined) ?
          attributeUniqueIdMap : {};
      THREE.DRACOLoader.getDecoderModule(
          function(dracoDecoder) {
            scope.decodeDracoFileInternal(rawBuffer, dracoDecoder,url, callback);
      });
    },

    decodeDracoFileInternal: function(rawBuffer, dracoDecoder,url, callback) {
      /*
