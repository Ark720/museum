...
THREE.ShaderLib['mirror'] = {
	...
	uniforms: { "mirrorColor": { type: "c", value: new THREE.Color(0x7F7F7F) },
		...
		"rotationX":{type:"f",value:Math.PI/2},
	...
	vertexShader: [
		...
		"texCoord =uv*vec2(repeatS, repeatT);",
	...
	fragmentShader: [
		...
		"return( base < 2.0 ? ( 2.0 * base * blend ) : (1.0 - 2.0 * ( 1.0 - base ) * ( 1.0 - blend ) ) );",
		"}",
		...
		"color = mix(mColor, color, clamp(dot(vNormal, normalize(eyeVec)/2.0+0.4), 0.4, alpha));",
		"gl_FragColor = color;",
...
THREE.Mirror = function ( renderer, camera, options ) {
	...
	var mirrorColor = options.color !== undefined ? new THREE.Color( options.color ) : new THREE.Color( 0x7F7F7F );//0x7F7F7F
